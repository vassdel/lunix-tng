 ...
 * Function prototypes
 */
// Helper functions (2 lines)
//int lunix_chrdev_state_needs_refresh(struct lunix_chrdev_state_struct state);
//int lunix_chrdev_state_update(struct lunix_chrdev_state_structstate);
